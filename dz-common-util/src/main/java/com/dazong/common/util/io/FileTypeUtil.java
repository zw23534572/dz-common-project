...
public class FileTypeUtil {
	...
	private static final String VIDEO_REGEX = "wmv|asf|rm|rmvb|mov|mp4|avi|3gp|mkv|flv|f4v|mpeg|mpg|dat|swf|ani";

	private static final String IMAGE_REGEX = "jpg|jpeg|gif|png|pcx|psd|tiff|bmp|ico|ppm|tif";

	private static final String COMPRESSION_REGEX = "zip|gz|7z|rar|bz|bz2|cab|gzip|jar|war|zipx|zz";

	private static final String AUDIO_REGEX = "wav|mp3|m4a|aac|m4p|midi";

	private static final String MSOFFICE_REGEX = "doc|docx";

	private static final Map<String, String> FILE_MAGIC_HEADERS = new HashMap<>();
